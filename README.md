...
2. Authenticate with AniList (or MAL/Simkl)
3. Or use a AniList public username (View Only)
4. For Authentication Guide: Setup → Authentication 
5. Choose the Authentication guide: AniList ( MAL/Simkl)
6. Follow the Guide properly

**Step 2:  Create Zoro folder**
1. Setup→ Sample Folder
2. click Create
3. Go back to your vault
4. Open Zoro folder
